...
G4ThreadLocal G4Allocator<ECalEmCalorimeterHit>* ECalEmCalorimeterHitAllocator;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

ECalEmCalorimeterHit::ECalEmCalorimeterHit()
: G4VHit(), 
...
ECalEmCalorimeterHit::ECalEmCalorimeterHit(G4int cellID)
: G4VHit(), 
...
ECalEmCalorimeterHit::ECalEmCalorimeterHit(const ECalEmCalorimeterHit &right)
: G4VHit(),
...
const ECalEmCalorimeterHit& ECalEmCalorimeterHit::operator=(const ECalEmCalorimeterHit
                                                          &right)
{
  fCellID = right.fCellID;
  fEdep = right.fEdep;
...
int ECalEmCalorimeterHit::operator==(const ECalEmCalorimeterHit &right) const
{
...
void ECalEmCalorimeterHit::Draw()
{
...
const std::map<G4String,G4AttDef>* ECalEmCalorimeterHit::GetAttDefs() const
{
  G4bool isNew;
  auto store = G4AttDefStore::GetInstance("ECalEmCalorimeterHit",isNew);
...
std::vector<G4AttValue>* ECalEmCalorimeterHit::CreateAttValues() const
{
...
void ECalEmCalorimeterHit::Print()
{
