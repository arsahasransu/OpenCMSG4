...
void Decay3Body::doDecay(const CLHEP::HepLorentzVector & mother,
...
// Rotate all three daughters momentum with the angles theta and phi:
    ...
    daughter1 = CLHEP::HepLorentzVector(q1,e1);
    daughter2 = CLHEP::HepLorentzVector(q2,e2);
    daughter3 = CLHEP::HepLorentzVector(q3,e3);
