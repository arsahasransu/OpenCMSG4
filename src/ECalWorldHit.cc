...
G4ThreadLocal G4Allocator<ECalWorldHit>* ECalWorldHitAllocator;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

ECalWorldHit::ECalWorldHit()
: G4VHit(), 
...
ECalWorldHit::ECalWorldHit(G4int cellID)
: G4VHit(), 
...
ECalWorldHit::ECalWorldHit(const ECalWorldHit &right)
: G4VHit(),
...
const ECalWorldHit& ECalWorldHit::operator=(const ECalWorldHit
                                                          &right)
{
  fCellID = right.fCellID;
  fEdep = right.fEdep;
...
int ECalWorldHit::operator==(const ECalWorldHit &right) const
{
...
const std::map<G4String,G4AttDef>* ECalWorldHit::GetAttDefs() const
{
  G4bool isNew;
  auto store = G4AttDefStore::GetInstance("ECalWorldHit",isNew);
...
std::vector<G4AttValue>* ECalWorldHit::CreateAttValues() const
{
  auto values = new std::vector<G4AttValue>;
  
  values
    ->push_back(G4AttValue("HitType","WorldHit",""));
  values
